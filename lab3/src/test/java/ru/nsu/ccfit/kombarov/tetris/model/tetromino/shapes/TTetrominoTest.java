...
class TTetrominoTest {
    ...
    @Test
    void constructorShouldCreateTTetrominoWithInitialState() {
        TTetromino tetromino = new TTetromino(10, 20);

        assertEquals("T", tetromino.getType());
    ...
    @Test
    void rotateClockwiseShouldSwitchThroughAllFourTShapes() {
        TTetromino tetromino = new TTetromino(10, 20);
    ...
    @Test
    void rotateCounterClockwiseShouldSwitchThroughAllFourTShapes() {
        TTetromino tetromino = new TTetromino(10, 20);
    ...
    void setPositionShouldMoveTetrominoToGivenPosition() {
        TTetromino tetromino = new TTetromino(0, 0);
    ...
    void copyShouldCreateIndependentTetrominoWithSameState() {
        ...
        assertInstanceOf(TTetromino.class, copy);
