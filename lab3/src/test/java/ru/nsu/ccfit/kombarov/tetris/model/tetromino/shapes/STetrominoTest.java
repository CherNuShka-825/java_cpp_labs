...
class STetrominoTest {
    ...
    @Test
    void constructorShouldCreateSTetrominoWithInitialState() {
        STetromino tetromino = new STetromino(10, 20);

        assertEquals("S", tetromino.getType());
    ...
    @Test
    void rotateClockwiseShouldSwitchThroughAllFourSShapes() {
        STetromino tetromino = new STetromino(10, 20);
    ...
    @Test
    void rotateCounterClockwiseShouldSwitchThroughAllFourSShapes() {
        STetromino tetromino = new STetromino(10, 20);
    ...
    void setPositionShouldMoveTetrominoToGivenPosition() {
        STetromino tetromino = new STetromino(0, 0);
    ...
    void copyShouldCreateIndependentTetrominoWithSameState() {
        ...
        assertInstanceOf(STetromino.class, copy);
