...
class JTetrominoTest {
    ...
    @Test
    void constructorShouldCreateJTetrominoWithInitialState() {
        JTetromino tetromino = new JTetromino(10, 20);

        assertEquals("J", tetromino.getType());
    ...
    @Test
    void rotateClockwiseShouldSwitchThroughAllFourJShapes() {
        JTetromino tetromino = new JTetromino(10, 20);
    ...
    @Test
    void rotateCounterClockwiseShouldSwitchThroughAllFourJShapes() {
        JTetromino tetromino = new JTetromino(10, 20);
    ...
    void setPositionShouldMoveTetrominoToGivenPosition() {
        JTetromino tetromino = new JTetromino(0, 0);
    ...
    void copyShouldCreateIndependentTetrominoWithSameState() {
        ...
        assertInstanceOf(JTetromino.class, copy);
